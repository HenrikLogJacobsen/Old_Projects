...
var Game = new function() {                                                                  
  ...
  // Handle Input
  var KEY_CODES = {37:'left', 65:"left", 39:'right', 68:"right", 38:"up", 87:"up", 40:"down", 83:"down", 32:'fire'};
  this.keys = {};
...
Level.prototype.step = function(dt) {
  ...
  this.t += dt * 1000;
  Game.time = 900 - Math.floor(this.t / 1000);
...
var TouchControls = function() {
  ...
  this.draw = function(ctx) {
    ...
    this.drawSquare(ctx,(unitWidth * 2) + gutterWidth,yLoc,"\u25B6", Game.keys['right']);
  ...
  this.trackTouch = function(e) {
    ...
    for(var i=0;i<e.targetTouches.length;i++) {
      ...
      if(x > unitWidth && x < unitWidth * 2 && y > Game.height - unitWidth) {
        Game.keys['down'] = true;
      }
      if(x > unitWidth && x < unitWidth * 2 && y < Game.height - unitWidth) {
        Game.keys['up'] = true;
      }
      if(x > unitWidth * 2 && x < unitWidth * 3) {
...
var GamePoints = function() {
  ...
  this.draw = function(ctx) {
    ...
    ctx.fillText("Score: " + zeros + txt,10,20);
    ctx.restore();
...
var GameTimer = function() {
  ...
  this.draw = function(ctx) {
    ...
    for(i = 2; i > minutes.toString().length; i--) {
      minutes += "0";
    }

    for(i = 2; i > seconds.toString().length; i--) {
      seconds += "0";
    }

    ctx.fillText(minutes + ":" + seconds,260,20);
    ctx.restore();
